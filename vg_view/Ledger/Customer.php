...
<div class="mainwrapper">
	...
	?>
        ...
        <div class="pagetitle">
        	<h1>Reports Customer Ledger  List</h1> 
        </div><!--pagetitle-->
       ...
       <div class="maincontent">
           ...
           <h4 class="widgettitle">Customer Name { 
       	     <select class="form-control required supplier " id="CustomerID" name="CustomerNmae" aria-required="true">
...
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td align="center" valign="top" style="color:#000;font-size:15px;">Mobile:01712-796563,01612-796563 <br />
      Email : solaimanfeedsltd@gmail.com</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	$productORder=$this->sql("SELECT `truck_no`,truck_rate,totla_kg FROM product_osm_accounts where `osm_full_id`='".$sup_accounts['ref_osm_full_id']."'");
      ...
      <tr>
        ...
        <td align="right"><strong><?php echo   number_format($Custiner_AC[0]['default_balance'],2);?></strong></td>
      </tr>
      <tr>
        <td colspan="7" align="right"><strong>Grant Total</strong></td>
        <td align="right"><strong><?php echo  number_format(($Custiner_AC[0]['default_balance']+$totalBalnce),2); ?></strong></td>
      </tr>
      </table></td>
  </tr>
</table>
           ...
           <p>&nbsp;</p>
           <form action="./?Ledger_CustomerPrint" target="_blank" method="post">
           <p align="right"><input type="submit" class="btn" value="Print" /></p>
           <input type="hidden" value="<?php echo $_POST['CustomerNmae'];?>" name="CustomerNmae" />
 ...
 <?php
				 ...
				 echo "<h2>Please Select Customer and Date....</h2>";
				 }
