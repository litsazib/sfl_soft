  ...
  <tr>
    <td height="5" colspan="3"><table width="100%" border="0">
      <tr>
		...
		echo number_format($netAmountCustomer[0]['netAmount']+$customer_accounts[0]['payment_amount'],2);
      ...
      <tr>
        ...
        <td><strong><?php echo number_format($netAmountCustomer[0]['netAmount'],2);?></strong></td>
        </tr>
    </table></td>
  </tr>
  <tr>
