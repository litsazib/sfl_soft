	...
	<?php require_once(View."menu.php");?>
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                ...
                <li class="active">Sales Product View</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
        	<h1>Sales Product View</h1> <span>This is a sample description for  Sales Product View page...</span>
        </div><!--pagetitle-->
...
<div class="contentinner">
   ...
   ?>
				...
				<div class="span6">
                  ...
                  <table class="table table-bordered table-invoice" >
                      <tr>
                          <td class="width30">Sales PD ID:</td>
                      ...
                      <tr>
						...
						echo $customerName[0]['customerName'];?></td>
                      </tr>
                      <tr>
                        <td>Issue Date:</td>
  ...
  <table width="100%" class="table table-bordered table-invoice-full">
          ...
          <thead>
              <tr>
                  <th width="76" class="head0">PD Code</th>
                  <th width="185" class="head1 right">Unit Bag KG</th>
                  <th width="164" class="head1 right">Total KG</th>
                  <th width="102" class="head1 right">Unit Price</th>
                  <th width="97" class="head1 right">Total Amount</th> 
                </tr>
          </thead>
          <tbody>
			...
			?>        
              <tr class="data-wrapper" <?php echo $corl;?>>
				  ...
				  ?></td>
                  <td align="center" class="right"><?php echo str_replace('-','',$productResult['stock_bag'])." => ".str_replace('-','',$productResult['bag_size'])." KG"?></td>
               ...
               <tr class="data-wrapper" <?php echo $corl;?>>
                ...
                <td align="center" class="right"><strong><?php echo str_replace('-','',$tBag);?></strong></td>
  ...
  <table width="100%" class="table invoice-table">
                    ...
                    <tbody>
                        <tr>
                        	...
                        	<td width="331" class="msg-invoice"><table width="100%" align="right" class="table table-bordered table-invoice" >
                        	  <tr style="color:#060;">
                        	    <td width="473" ><strong>Truck Fee</strong></td>
                        	    <td width="359" ><span class="width70"><?php echo $orderInfo[0]['truck_rate'];?></span></td>
                      	    </tr>
                        	  <tr style="color:#060;">
    ...
    <a class="btn" href="<?php echo BASE_URL?>?SingelReport_salesINVPDF&getID=<?php echo $product_accounts[0]['osm_fulll_id'];?>" target="_blank">Print</a>
